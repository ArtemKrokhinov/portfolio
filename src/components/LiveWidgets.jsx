  ...
  return (
    <BentoCard spanClasses={spanClasses} style={{ justifyContent: 'center', alignItems: 'center', padding: '1.5rem' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', width: '100%', height: '100%' }}>
        <a href="https://github.com/ArtemKrokhinov" target="_blank" rel="noreferrer" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: '1rem', borderRadius: '12px', backgroundColor: 'rgba(255,255,255,0.03)', transition: 'background 0.3s' }} className="social-btn">
